...
<body class="is-preload">
	...
	<div id="wrapper" class="fade-in">
		...
		<!-- pasek z logo -->
		<header id="header">
			<a href="{$conf->app_url}" class="logo">Kalkulator kredytowy</a>
		</header>

		<!-- menu na pasku -->
		<nav id="nav">
			<ul class="links">
				<li class="inactive"><a href="{$conf->app_url}">Kalkulator</a></li>
                                <li class="inactive"><a href="{$conf->app_url}/innaApp/inna_chroniona.php">Inna chroniona</a></li>
			</ul>
		</nav>
