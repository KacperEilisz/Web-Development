...
require_once $conf->root_path.'/calcApp/CalcForm.class.php';
require_once $conf->root_path.'/calcApp/CalcResult.class.php';
...
class CalcCtrl {
   ...
   public function generateView(){
    ...
    $smarty->display($conf->root_path.'/calcApp/calc_view.tpl');
}
}